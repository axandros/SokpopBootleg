// PCH for F:\Program Files (x86)\UE_4.26\Engine\Source\Runtime\Engine\Public\EngineSharedPCH.h
#define IS_PROGRAM 0
#define UE_EDITOR 1
...
#include "F:/Program Files (x86)/UE_4.26/Engine/Source/Runtime/Engine/Public/EngineSharedPCH.h"
